...
For every integer $m\geq 0$, the repository supports the exact logical-circuit
theorem
...
$a_j\geq 0$ and equals the principal metric square root.  At zero metric weight,
