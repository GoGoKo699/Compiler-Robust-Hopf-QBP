...
$y$ the two-bit system X-basis label. The correct frame has probability $\frac{1}{4}$
on
...
and zero elsewhere. The state-equivalent compiler has probability $\frac{1}{4}$ on

```text
(0,00), (0,10), (1,01), (1,11),
```

and zero elsewhere. Their total-variation distance is $\frac{1}{2}$.
...
The total-variation distance is $\frac{1}{4}$.
