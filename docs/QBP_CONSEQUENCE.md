...
$g_{j,j}=a_j^2$.  On the canonical Hopf domains, $a_j\geq 0$ and
...
time, with $O\!\left(N\right)$ storage for the dense transform.  This is a classical output
...
For $M=\Theta\!\left(N\right)$ Hopf coordinates and $n=\Theta\!\left(log M\right)$, this is
