...
and let $m\geq 0$ be the number of clean ancillary qubits.  In the exact all-to-all
...
the canonical Hopf domains, $a_j\geq 0$ and equals the principal metric square
...
$M=\Theta\!\left(2^n\right)$ is the number of coordinates.
